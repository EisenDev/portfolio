...
const colorMap = {
    blue: { bg: "rgba(59,130,246,0.05)", borderHover: "hover:border-blue-500", borderDefault: "border-blue-500/20", text: "text-blue-500", textLight: "text-blue-500", bgLight: "bg-blue-500/10", textOutput: "text-[var(--color-text-primary)]", btnBorder: "border-blue-500/30", btnHover: "hover:bg-blue-500 hover:text-white" },
    orange: { bg: "rgba(242,78,30,0.05)", borderHover: "hover:border-orange-500", borderDefault: "border-orange-500/20", text: "text-orange-500", textLight: "text-orange-500", bgLight: "bg-orange-500/10", textOutput: "text-[var(--color-text-primary)]", btnBorder: "border-orange-500/30", btnHover: "hover:bg-orange-500 hover:text-white" },
    emerald: { bg: "rgba(16,185,129,0.05)", borderHover: "hover:border-emerald-500", borderDefault: "border-emerald-500/20", text: "text-emerald-500", textLight: "text-emerald-500", bgLight: "bg-emerald-500/10", textOutput: "text-[var(--color-text-primary)]", btnBorder: "border-emerald-500/30", btnHover: "hover:bg-emerald-500 hover:text-white" },
    yellow: { bg: "rgba(234,179,8,0.05)", borderHover: "hover:border-yellow-500", borderDefault: "border-yellow-500/20", text: "text-yellow-500", textLight: "text-yellow-500", bgLight: "bg-yellow-500/10", textOutput: "text-[var(--color-text-primary)]", btnBorder: "border-yellow-500/30", btnHover: "hover:bg-yellow-500 hover:text-white" },
    purple: { bg: "rgba(168,85,247,0.05)", borderHover: "hover:border-purple-500", borderDefault: "border-purple-500/20", text: "text-purple-500", textLight: "text-purple-500", bgLight: "bg-purple-500/10", textOutput: "text-[var(--color-text-primary)]", btnBorder: "border-purple-500/30", btnHover: "hover:bg-purple-500 hover:text-white" },
    cyan: { bg: "rgba(6,182,212,0.05)", borderHover: "hover:border-cyan-500", borderDefault: "border-cyan-500/20", text: "text-cyan-500", textLight: "text-cyan-500", bgLight: "bg-cyan-500/10", textOutput: "text-[var(--color-text-primary)]", btnBorder: "border-cyan-500/30", btnHover: "hover:bg-cyan-500 hover:text-white" },
    pink: { bg: "rgba(236,72,153,0.05)", borderHover: "hover:border-pink-500", borderDefault: "border-pink-500/20", text: "text-pink-500", textLight: "text-pink-500", bgLight: "bg-pink-500/10", textOutput: "text-[var(--color-text-primary)]", btnBorder: "border-pink-500/30", btnHover: "hover:bg-pink-500 hover:text-white" },
    red: { bg: "rgba(239,68,68,0.05)", borderHover: "hover:border-red-500", borderDefault: "border-red-500/20", text: "text-red-500", textLight: "text-red-500", bgLight: "bg-red-500/10", textOutput: "text-[var(--color-text-primary)]", btnBorder: "border-red-500/30", btnHover: "hover:bg-red-500 hover:text-white" },
    indigo: { bg: "rgba(99,102,241,0.05)", borderHover: "hover:border-indigo-500", borderDefault: "border-indigo-500/20", text: "text-indigo-500", textLight: "text-indigo-500", bgLight: "bg-indigo-500/10", textOutput: "text-[var(--color-text-primary)]", btnBorder: "border-indigo-500/30", btnHover: "hover:bg-indigo-500 hover:text-white" },
    teal: { bg: "rgba(20,184,166,0.05)", borderHover: "hover:border-teal-500", borderDefault: "border-teal-500/20", text: "text-teal-500", textLight: "text-teal-500", bgLight: "bg-teal-500/10", textOutput: "text-[var(--color-text-primary)]", btnBorder: "border-teal-500/30", btnHover: "hover:bg-teal-500 hover:text-white" },
};
