...
export default function CommandCenter() {
    ...
    return (
        <section id="command-center" className="min-h-screen relative flex flex-col justify-center pt-16 md:pt-24 pb-12 overflow-hidden bg-[var(--color-bg-primary)]">
            {/* Background Glows */}
            ...
            <div className="container mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 relative z-10 items-center">
                {/* Texts */}
                <div className="flex flex-col justify-center space-y-6 md:space-y-8 order-2 lg:order-1">
                    <div className="space-y-3 md:space-y-4">
                        ...
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight leading-tight text-[var(--color-text-primary)]">
                            I design and build{" "}
                    ...
                    <p className="text-lg md:text-xl md:text-2xl font-light text-[var(--color-text-secondary)] leading-relaxed max-w-2xl">
                    ...
                    <div className="flex flex-col sm:flex-row flex-wrap gap-4 pt-4">
                        <Link href="/dossier" className="w-full sm:w-auto text-center px-6 py-3 md:py-4 bg-[var(--color-brand-500)] text-white font-bold rounded-lg hover:bg-[var(--color-brand-600)] transition-colors shadow-[0_0_20px_rgba(16,185,129,0.4)] md:text-base text-sm">
                            :: VIEW DOSSIER
                        </Link>
                        <Link href="/logs" className="w-full sm:w-auto text-center px-6 py-3 md:py-4 border border-[var(--color-border-subtle)] text-[var(--color-text-primary)] rounded-lg hover:bg-[var(--color-brand-500)]/10 transition-colors font-semibold md:text-base text-sm">
                            SYSTEM LOGS
                        </Link>
                    </div>
                </div>
                ...
                {/* Visuals */}
                <div className="relative flex items-center justify-center order-1 lg:order-2 h-[40vh] lg:h-auto min-h-[300px] md:min-h-[400px]">
